namespace SSOPortalX.Data.App.User.Dto;
...
public class UserDto : IComparable
{
    ...
    public UserDto(SSOPortalX.Data.Models.User user)
    {
        Id = user.Id.ToString();
        ...
        // Initialize other properties to default values as they are not in the User model
        Plan = "Basic";
        Country = "";
        Contact = "";
        Company = "";
        Sales = "";
        Profit = "";
        BirthDate = DateOnly.FromDateTime(System.DateTime.Now);
        Mobile = "";
        Website = "";
        Language = "English";
        Gender = "";
