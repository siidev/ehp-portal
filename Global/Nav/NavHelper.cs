...
public class NavHelper
{
    ...
    private void Initialization()
    {
        ...
        // Ensure more specific paths are matched first when resolving tab titles.
        // This prevents generic parents like "My Applications" from overriding child pages.
        PageTabItems.Sort((a, b) => (b.Href?.Length ?? 0).CompareTo(a.Href?.Length ?? 0));
    }
